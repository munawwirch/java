...
public class co3_3{
    public static void main(String[] args) {
        ...
        teachers[0] = new Teacher("amal","male","vadakara",32,1001,
                "eduport","msc",45000,"maths","science","T101");

        teachers[1] = new Teacher("shahana","female","calicut",29,1002,
                "xylem","phd",50000,"physics","science","T103");
